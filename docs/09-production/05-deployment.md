...
**Option 2: Export a `.clerapack` and import on macOS**

From Clera Studio on any platform, use **Export as .clerapack**. This produces a single portable file containing your full project. Transfer it to a Mac, open Clera Studio, and use **Import .clerapack** to restore the project and export the iOS target.

The `.clerapack` is the recommended way to hand off a project between machines or collaborators. It is self-contained and platform-independent.
...
[10-ai: Clera AI Overview](../10-ai/01-clera-ai-overview.md)
